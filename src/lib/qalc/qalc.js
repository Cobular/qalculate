...
var Module = (function () {
  ...
  return function (Module) {
    ...
    function getBinary(file) {
      console.log("getBinary", file);
      try {
        if (file == wasmBinaryFile && wasmBinary) {
          return new Uint8Array(wasmBinary);
        }
        const this_path = path.join(environment.assetsPath, file);
        console.log("getBinary", readBinary, this_path);
        return readFileSync(this_path);
        if (readBinary) {
          console.log("reading binary file: " + file);
    ...
    function getBinaryPromise() {
      ...
      return Promise.resolve().then(function () {
        console.log("getBinaryPromise", wasmBinaryFile);
        return getBinary(wasmBinaryFile);
      });
    }
    function createWasm() {
    ...
    var ___errno_location = (Module["___errno_location"] = function () {
      return (___errno_location = Module["___errno_location"] = Module["asm"]["ha"]).apply(null, arguments);
    });
    var ___getTypeName = (Module["___getTypeName"] = function () {
      return (___getTypeName = Module["___getTypeName"] = Module["asm"]["ia"]).apply(null, arguments);
    });
    ...
    var __get_tzname = (Module["__get_tzname"] = function () {
      return (__get_tzname = Module["__get_tzname"] = Module["asm"]["ka"]).apply(null, arguments);
    });
    var __get_daylight = (Module["__get_daylight"] = function () {
      return (__get_daylight = Module["__get_daylight"] = Module["asm"]["la"]).apply(null, arguments);
    });
    var __get_timezone = (Module["__get_timezone"] = function () {
      return (__get_timezone = Module["__get_timezone"] = Module["asm"]["ma"]).apply(null, arguments);
    });
